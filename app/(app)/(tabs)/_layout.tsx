        ...
        >
            ...
            <Tabs.Screen
                ...
                options={{
                    title: 'transactions',
                    tabBarIcon: ({ color, focused }) => (
                        <CustomTabBarLabel name={focused ? 'swap-horizontal' : 'swap-horizontal-outline'} title="Transactions" color={color} focused={focused} />
                    ),
                }}
            />
            <Tabs.Screen
                ...
                options={{
                    title: 'history',
                    tabBarIcon: ({ color, focused }) => (
                        <CustomTabBarLabel name={focused ? 'timer' : 'timer-outline'} title="History" color={color} focused={focused} />
                    ),
                }}
            />
        </Tabs>
